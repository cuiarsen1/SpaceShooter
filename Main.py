...
ship = pygame.image.load('Spaceship.png') # The spaceship that the player controls
ship = pygame.transform.scale(ship, (50, 50))
enemy = pygame.image.load('Enemy.png') # The enemies that the player have to kill
enemy = pygame.transform.scale(enemy, (50, 50))
background = pygame.image.load('GameBG.png') # The background of the game
background = pygame.transform.scale(background, (800, 600))
osu = pygame.image.load('OSU2.png') # The bullets that the spaceship shoots
